package com.example.medicalequipment.config;
...
import com.example.medicalequipment.security.auth.RestAuthenticationEntryPoint;
import com.example.medicalequipment.security.auth.TokenAuthenticationFilter;
import com.example.medicalequipment.service.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    	...
    	http.authorizeRequests()	// /auth/**
			...
			.antMatchers("/api/registratedUser/**").hasAuthority("ROLE_REGISTRATED_USER")
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
    	...
    	return (web) -> web.ignoring().antMatchers(HttpMethod.POST, "/auth/login")
    			...
    			"/**/*.html", "/**/*.css", "/**/*.js","/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/security", "/swagger-ui.html", "/webjars/**");	 
