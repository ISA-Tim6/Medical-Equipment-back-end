...
public interface IReservationRepository extends JpaRepository<Reservation, Long>{
	...
	@Query("select r from Reservation r join fetch r.items join fetch r.user join fetch r.appointment a join fetch a.admin ca join fetch ca.company c where r.appointment.appointment_id=?1")
	List<Reservation> getByAppointmentId(Long id);
}
